...
// CaptureRuntimeMemStats; new values for the Go runtime statistics exported in
...
// RegisterRuntimeMemStats; for the Go runtime statistics exported in runtime and
